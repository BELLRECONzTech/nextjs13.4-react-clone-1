  ...
  return (
    ...
    <div className='w-full h-full m-60  flex md:flex gap-20 mt-20'>
        ...
        <div className='max-w-[600px] h-auto'>
            ...
            <h2 className='mt-10  text-gray-600'>Our dedicated patient engagement app and web portal allow you to access information instantaneously (no tedeous form, long calls, or administrative hassle) and securely</h2>

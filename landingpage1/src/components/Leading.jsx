  ...
  return (
    <div className='w-full h-full m-44 p-40 flex md:flex gap-20'>
        ...
        <div className='max-w-[600px] h-auto'>
            ...
            <h2 className='mt-10  '>Trafalgar provides progressive, and affordable healthcare, accessible on mobile and online for everyone. To us, it’s not just work. We take pride in the solutions we deliver</h2>

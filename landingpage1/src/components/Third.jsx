            ...
            <div className='w-full h-screen absolute'>
                <div className='grid grid-cols-3 mx-20 p-20  gap-10'>
                    ...
                    <Image 
                        ...
                        <h2 className='mt-3'>Choose your doctor from thousands of specialist, general, and trusted hospitals</h2>
                    </div>
                    ...
                    <Image 
                        ...
                        <h2 className='  mt-3'>Buy  your medicines with our mobile application with a simple delivery system</h2>
                    </div>
                    ...
                    <Image 
                        ...
                        <h2 className='  mt-3'>Free consultation with our trusted doctors and get the best recomendations</h2>
                    </div>
                    ...
                    <Image 
                        ...
                        <h2 className=' mt-3'>You can get 24/7 urgent care for yourself or your children and your lovely family</h2>
                    </div>
                    ...
                    <Image 
                        ...
                        <h2 className='  mt-3'>Track and save your medical history and health data </h2>
                    </div>
                </div>
